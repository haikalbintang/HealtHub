...
interface healtyRecipeProps {
  categories: string[];
}

const healtyRecipe: React.FC<healtyRecipeProps> = () => {
    ...
    <div className="item-list">
      ...
      <div className=" pr-16 ">
        <div className="grid grid-cols-4 gap-7 px-20 py-10 ">
          {recipes
            .filter((recipe) => recipe.type === "Healty Recipe")
            .slice(0, showCount)
            .map((recipe, index) => (
              <div
        ...
        <div className="px-10 pt-4 flex justify-end items-center gap-2">
          ...
          {showCount <
            recipes.filter((recipe) => recipe.type === "healtyRecipe")
              .length && (
